...
export default function Accounts() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <DialogAddAccount open={openAddDialog} onOpenChange={setOpenAddDialog}/>
      <DialogAlterAccount open={openAlterDialog} onOpenChange={setOpenAlterDialog} data={selectedAccount}/>
    </div>
  );
}
